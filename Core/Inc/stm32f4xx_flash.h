...
#define FLASH_Latency_13                                                                           \
  ((uint8_t)0x000D) /*!< FLASH Thirteen Latency cycles                                             \
                     */
#define FLASH_Latency_14                                                                           \
  ((uint8_t)0x000E) /*!< FLASH Fourteen Latency cycles                                             \
                     */
#define FLASH_Latency_15                                                                           \
  ((uint8_t)0x000F) /*!< FLASH Fifteen Latency cycles                                              \
                     */
...
#define IS_OB_WRP(SECTOR)                                                                          \
  ((((SECTOR) & (uint32_t)0xFFFFF000) == 0x00000000) && ((SECTOR) != 0x00000000))
/**
 * @}
 */
 ...
 * @{
 */
#define OB_PcROP_Disable                                                                           \
  ((uint8_t)0x00) /*!< Disabled PcROP, nWPRi bits used for Write Protection on                     \
                     sector i */
#define OB_PcROP_Enable                                                                            \
...
/*#define OB_RDP_Level_2   ((uint8_t)0xCC)*/ /*!< Warning: When enabling read
                                                protection level 2 it's no more
                                                possible to go back to level 1
                                                or 0 */
...
//#define OB_STDBY_RST                   ((uint8_t)0x00) /*!< Reset generated
// when entering in STANDBY */ #define IS_OB_STDBY_SOURCE(SOURCE) (((SOURCE) ==
// OB_STDBY_NoRST) || ((SOURCE) == OB_STDBY_RST))
/**
 * @}
 */
 ...
 * @{
 */
#define OB_Dual_BootEnabled                                                                        \
  ((uint8_t)0x10) /*!< Dual Bank Boot Enable                             */
#define OB_Dual_BootDisabled                                                                       \
...
#define IS_FLASH_GET_FLAG(FLAG)                                                                    \
  (((FLAG) == FLASH_FLAG_EOP) || ((FLAG) == FLASH_FLAG_OPERR) || ((FLAG) == FLASH_FLAG_WRPERR) ||  \
   ((FLAG) == FLASH_FLAG_PGAERR) || ((FLAG) == FLASH_FLAG_PGPERR) ||                               \
   ((FLAG) == FLASH_FLAG_PGSERR) || ((FLAG) == FLASH_FLAG_BSY) || ((FLAG) == FLASH_FLAG_RDERR))
